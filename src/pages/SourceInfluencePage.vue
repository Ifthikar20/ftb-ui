    ...
    <template v-if="hasActiveRun">
      ...
      <section v-if="displayRun?.analysis?.markdown" class="mt-card mt-synth">
        ...
        >
          ...
          <span class="mt-collapse-caret" :class="{ 'is-open': synthesisOpen }">
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.5">
              <path d="M3 5l4 4 4-4" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </span>
        </button>
        <div v-if="synthesisOpen" class="mt-md" v-html="renderMarkdown(displayRun.analysis.markdown)"></div>
      </section>
      ...
      <section v-if="displayRun?.google_grounding?.markdown" class="mt-card mt-ground">
        ...
        >
          <div>
            ...
            <p v-if="groundingOpen" class="mt-card-sub">
          ...
          <span class="mt-collapse-caret" :class="{ 'is-open': groundingOpen }">
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.5">
              <path d="M3 5l4 4 4-4" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </span>
...
// Top-level collapsibles for the synthesis + grounding cards. Open
// by default — the user can click the card header to collapse.
...
.mt-collapse-head:hover .mt-card-h { color: #475569; }
.mt-collapse-head:hover .mt-collapse-caret { color: #0f172a; }
.mt-collapse-caret {
  flex: none;
  width: 28px; height: 28px;
  display: inline-flex; align-items: center; justify-content: center;
...
.mt-collapse-caret.is-open { transform: rotate(180deg); color: #0f172a; }
.mt-md {
