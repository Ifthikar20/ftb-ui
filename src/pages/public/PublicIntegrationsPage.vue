...
const integrations = [
  ...
  { slug: 'perplexity', name: 'Perplexity AI', category: 'Analytics & AI', categoryKey: 'analytics', status: 'needs-key', usedIn: 'LLM Dashboard', shortDesc: 'Test how your brand appears in Perplexity AI search responses.', logo: 'https://cdn.simpleicons.org/perplexity/20808D', tagColor: '#20808d', tagBg: '#20808d10' },
