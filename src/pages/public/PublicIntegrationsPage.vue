...
const integrations = [
  ...
  { slug: 'anthropic', name: 'Anthropic Claude', category: 'Analytics & AI', categoryKey: 'analytics', status: 'active', usedIn: 'Agents, AI Insights, LLM Ranking', shortDesc: 'Powers AI lead finder, agent engine, LLM ranking checker, and AI keyword insights.', logo: 'https://cdn.brandfetch.io/idgvU5PlJs/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#d97706', tagBg: '#d9770610' },
  { slug: 'google-search', name: 'Google Custom Search', category: 'Analytics & AI', categoryKey: 'analytics', status: 'active', usedIn: 'Leads → AI Lead Finder', shortDesc: 'Enables AI Lead Finder to discover prospects by scraping Google search results.', logo: 'https://cdn.brandfetch.io/idS5WhqBbM/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#4285f4', tagBg: '#4285f410' },
  { slug: 'gemini', name: 'Google Gemini', category: 'Analytics & AI', categoryKey: 'analytics', status: 'needs-key', usedIn: 'Reserved for future AI tasks', shortDesc: 'Google\'s multimodal AI model — configured but not yet active in any module.', logo: 'https://cdn.brandfetch.io/idS5WhqBbM/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#4285f4', tagBg: '#4285f410' },
  { slug: 'perplexity', name: 'Perplexity AI', category: 'Analytics & AI', categoryKey: 'analytics', status: 'needs-key', usedIn: 'LLM Ranking', shortDesc: 'Test how your brand appears in Perplexity AI search responses.', logo: 'https://cdn.brandfetch.io/id4u-CyJCn/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#20808d', tagBg: '#20808d10' },

  // Messaging
  { slug: 'slack', name: 'Slack', category: 'Messaging', categoryKey: 'messaging', status: 'active', usedIn: 'Settings → Integrations', shortDesc: 'Daily growth reports, hot lead alerts, and trend intelligence delivered to Slack channels.', logo: 'https://cdn.brandfetch.io/idBZMioBmb/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#4A154B', tagBg: '#4A154B10' },
  { slug: 'discord', name: 'Discord', category: 'Messaging', categoryKey: 'messaging', status: 'active', usedIn: 'Settings → Integrations', shortDesc: 'Rich-embed growth reports and lead alerts in your Discord server.', logo: 'https://cdn.brandfetch.io/idSUrLOWbf/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#5865F2', tagBg: '#5865F210' },
  { slug: 'telegram', name: 'Telegram', category: 'Messaging', categoryKey: 'messaging', status: 'active', usedIn: 'Settings → Integrations', shortDesc: 'Instant push notifications for growth milestones and hot leads on mobile.', logo: 'https://cdn.brandfetch.io/id--5lFBH-/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#229ED9', tagBg: '#229ED910' },

  // CRM & Email
  { slug: 'sendgrid', name: 'SendGrid', category: 'CRM & Email', categoryKey: 'crm', status: 'active', usedIn: 'Campaigns → Email, Voice Agent', shortDesc: 'Transactional and campaign email delivery powered by SendGrid\'s API.', logo: 'https://cdn.brandfetch.io/idBVwj2lVd/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#1A82e2', tagBg: '#1A82e210' },
  { slug: 'mailchimp', name: 'Mailchimp', category: 'CRM & Email', categoryKey: 'crm', status: 'active', usedIn: 'Campaigns → Audience Sync', shortDesc: 'Sync lead segments to Mailchimp audiences for targeted email campaigns.', logo: 'https://cdn.brandfetch.io/idjWz4L_P1/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#ffe01b', tagBg: '#ffe01b15' },
  { slug: 'hubspot', name: 'HubSpot', category: 'CRM & Email', categoryKey: 'crm', status: 'needs-key', usedIn: 'Leads → CRM Sync', shortDesc: 'Bidirectional lead, deal, and contact sync with HubSpot CRM.', logo: 'https://cdn.brandfetch.io/idchmboHEZ/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#ff7a59', tagBg: '#ff7a5910' },

  // Ads & Social
  { slug: 'facebook', name: 'Facebook / Meta', category: 'Ads & Social', categoryKey: 'ads', status: 'needs-key', usedIn: 'Social Leads → Facebook', shortDesc: 'Capture Facebook Lead Ads and track ad-driven conversions.', logo: 'https://cdn.brandfetch.io/idtRGwMrG2/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#1877f2', tagBg: '#1877f210' },
  { slug: 'linkedin', name: 'LinkedIn', category: 'Ads & Social', categoryKey: 'ads', status: 'needs-key', usedIn: 'Social Leads → LinkedIn', shortDesc: 'Import leads and sync B2B contact data from LinkedIn.', logo: 'https://cdn.brandfetch.io/idawOgYOsG/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#0a66c2', tagBg: '#0a66c210' },
  { slug: 'x-twitter', name: 'X (Twitter)', category: 'Ads & Social', categoryKey: 'ads', status: 'needs-key', usedIn: 'Keywords → Trending Topics', shortDesc: 'Import trending topics from X to drive content strategy.', logo: 'https://cdn.brandfetch.io/idZAyF9rlg/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#14171a', tagBg: '#14171a10' },
  { slug: 'tiktok', name: 'TikTok', category: 'Ads & Social', categoryKey: 'ads', status: 'needs-key', usedIn: 'Social Leads (planned)', shortDesc: 'Social lead capture and ad attribution from TikTok.', logo: 'https://cdn.brandfetch.io/idUevYCaHW/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#000000', tagBg: '#00000008' },

  // Payments
  { slug: 'stripe', name: 'Stripe', category: 'Payments', categoryKey: 'payments', status: 'active', usedIn: 'Billing → Subscriptions', shortDesc: 'Subscription billing, payment processing, and revenue attribution.', logo: 'https://cdn.brandfetch.io/idxAg10C0L/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#635bff', tagBg: '#635bff10' },

  // SEO & Search
  { slug: 'google-search-console', name: 'Google Search Console', category: 'SEO & Search', categoryKey: 'seo', status: 'needs-key', usedIn: 'Keywords → Rankings (planned)', shortDesc: 'Pull real Google ranking data, impressions, and CTR.', logo: 'https://cdn.brandfetch.io/idS5WhqBbM/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#4285f4', tagBg: '#4285f410' },
  { slug: 'dataforseo', name: 'DataForSEO', category: 'SEO & Search', categoryKey: 'seo', status: 'active', usedIn: 'Keywords → Position Tracking', shortDesc: 'Real Google SERP rankings, search volume, CPC, and keyword difficulty data.', logo: 'https://cdn.brandfetch.io/idJX-AKleh/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#27ae60', tagBg: '#27ae6010' },
  { slug: 'semrush', name: 'Semrush', category: 'SEO & Search', categoryKey: 'seo', status: 'needs-key', usedIn: 'Keywords (planned)', shortDesc: 'Compete analysis, keyword rankings, backlink data from Semrush.', logo: 'https://cdn.brandfetch.io/ideTXz7HkP/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#ff622d', tagBg: '#ff622d10' },

  // Voice & Calls
  { slug: 'retell-ai', name: 'Retell.ai', category: 'Voice & Calls', categoryKey: 'voice', status: 'active', usedIn: 'Voice Agent → Managed', shortDesc: 'Power AI voice agents with ultra-realistic conversations for outbound calls.', logo: 'https://cdn.brandfetch.io/idia0OQj_R/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#8b5cf6', tagBg: '#8b5cf610' },
  { slug: 'telnyx', name: 'Telnyx', category: 'Voice & Calls', categoryKey: 'voice', status: 'active', usedIn: 'Voice Agent → Phone Numbers', shortDesc: 'Buy, verify, and manage phone numbers for AI voice agent campaigns.', logo: 'https://cdn.brandfetch.io/idHNOFtw6k/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#00c04b', tagBg: '#00c04b10' },
  { slug: 'livekit', name: 'LiveKit', category: 'Voice & Calls', categoryKey: 'voice', status: 'active', usedIn: 'Voice Agent → Browser Calling', shortDesc: 'Real-time voice and video infrastructure for browser-based calling.', logo: 'https://cdn.brandfetch.io/idEZpPWK5V/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#0d6efd', tagBg: '#0d6efd10' },
  { slug: 'deepgram', name: 'Deepgram', category: 'Voice & Calls', categoryKey: 'voice', status: 'needs-key', usedIn: 'Voice Agent → STT', shortDesc: 'Speech-to-text transcription for voice agent conversations.', logo: 'https://cdn.brandfetch.io/id6oBMk3sJ/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#13ef93', tagBg: '#13ef9310' },

  // Automation
  { slug: 'google-oauth', name: 'Google OAuth', category: 'Automation', categoryKey: 'automation', status: 'active', usedIn: 'Login, Google Drive Export', shortDesc: 'Secure login and data export to Google Sheets and Google Drive.', logo: 'https://cdn.brandfetch.io/idS5WhqBbM/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#4285f4', tagBg: '#4285f410' },
  { slug: 'google-drive', name: 'Google Drive', category: 'Automation', categoryKey: 'automation', status: 'active', usedIn: 'Leads → Export to Drive', shortDesc: 'Export leads and analytics data to Google Drive spreadsheets.', logo: 'https://cdn.brandfetch.io/idS5WhqBbM/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#0f9d58', tagBg: '#0f9d5810' },
  { slug: 'sentry', name: 'Sentry', category: 'Automation', categoryKey: 'automation', status: 'active', usedIn: 'Error Monitoring (infra)', shortDesc: 'Real-time error tracking and performance monitoring for the platform.', logo: 'https://cdn.brandfetch.io/idLGnxgVGF/w/400/h/400/theme/dark/icon.jpeg', tagColor: '#362d59', tagBg: '#362d5910' },
