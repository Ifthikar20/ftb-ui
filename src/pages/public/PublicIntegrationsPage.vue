...
const integrations = [
  ...
  // CRM & Email
  { slug: 'sendgrid', name: 'SendGrid', category: 'CRM & Email', categoryKey: 'crm', status: 'active', usedIn: 'Campaigns → Email, Voice Agent', shortDesc: 'Transactional and campaign email delivery powered by SendGrid\'s API.', logo: 'https://cdn.simpleicons.org/minutemailer/1A82E2', tagColor: '#F22F46', tagBg: '#F22F4610' },
  ...
  { slug: 'linkedin', name: 'LinkedIn', category: 'Ads & Social', categoryKey: 'ads', status: 'needs-key', usedIn: 'Social Leads → LinkedIn', shortDesc: 'Import leads and sync B2B contact data from LinkedIn.', logo: 'https://cdn.simpleicons.org/linkedin/0a66c2', tagColor: '#0A66C2', tagBg: '#0A66C210' },
  ...
  // Voice & Calls
  { slug: 'retell-ai', name: 'Retell.ai', category: 'Voice & Calls', categoryKey: 'voice', status: 'active', usedIn: 'Voice Agent → Managed', shortDesc: 'Power AI voice agents with ultra-realistic conversations for outbound calls.', logo: 'https://cdn.simpleicons.org/openai/8B5CF6', tagColor: '#8b5cf6', tagBg: '#8b5cf610' },
  { slug: 'telnyx', name: 'Telnyx', category: 'Voice & Calls', categoryKey: 'voice', status: 'active', usedIn: 'Voice Agent → Phone Numbers', shortDesc: 'Buy, verify, and manage phone numbers for AI voice agent campaigns.', logo: 'https://cdn.simpleicons.org/twilio/00C04B', tagColor: '#00c04b', tagBg: '#00c04b10' },
  ...
  { slug: 'deepgram', name: 'Deepgram', category: 'Voice & Calls', categoryKey: 'voice', status: 'needs-key', usedIn: 'Voice Agent → STT', shortDesc: 'Speech-to-text transcription for voice agent conversations.', logo: 'https://cdn.simpleicons.org/openai/13EF93', tagColor: '#13ef93', tagBg: '#13ef9310' },
