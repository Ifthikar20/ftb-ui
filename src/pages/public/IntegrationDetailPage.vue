...
const allIntegrations = [
  ...
  { slug: 'sendgrid', name: 'SendGrid', category: 'CRM & Email', categoryKey: 'crm', status: 'active', usedIn: 'Campaigns → Email', shortDesc: 'Transactional and campaign email delivery powered by SendGrid\'s API.', logo: '/images/integrations/sendgrid.svg', tagColor: '#1A82e2', tagBg: '#1A82e210', envVars: 'SENDGRID_API_KEY', longDesc: 'SendGrid powers all transactional and marketing emails in FetchBot, including campaign emails and system notifications.', features: ['Campaign emails', 'Transactional emails', 'Lifecycle automations', 'Delivery analytics'], docsUrl: '#' },
  ...
  // HubSpot intentionally hidden — detail route falls through to the not-found state.
