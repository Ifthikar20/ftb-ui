...
const allIntegrations = [
  ...
  { slug: 'retell-ai', name: 'Retell.ai', category: 'Voice & Calls', categoryKey: 'voice', status: 'active', usedIn: 'Voice Agent → Managed', shortDesc: 'Power AI voice agents with ultra-realistic conversations for outbound calls.', logo: '/images/integrations/retell.svg', tagColor: '#8b5cf6', tagBg: '#8b5cf610', envVars: 'RETELL_API_KEY', longDesc: 'Retell.ai powers FetchBot\'s managed Voice Agent with ultra-realistic AI voice conversations. Build outbound call campaigns with AI agents that sound human.', features: ['AI voice calling', 'Natural conversations', 'Call campaigns', 'Transcript extraction'], docsUrl: '#' },
  { slug: 'telnyx', name: 'Telnyx', category: 'Voice & Calls', categoryKey: 'voice', status: 'active', usedIn: 'Voice Agent → Phone Numbers', shortDesc: 'Buy, verify, and manage phone numbers for AI voice agent campaigns.', logo: '/images/integrations/telnyx.svg', tagColor: '#00c04b', tagBg: '#00c04b10', envVars: 'TELNYX_API_KEY', longDesc: 'Telnyx provides phone number provisioning, SIP trunking, and outbound dialing for FetchBot\'s voice agent system.', features: ['Phone number provisioning', 'SIP trunking', 'Outbound dialing', 'Call recording'], docsUrl: '#' },
  ...
  { slug: 'linkedin', name: 'LinkedIn', category: 'Ads & Social', categoryKey: 'ads', status: 'needs-key', usedIn: 'Social Leads → LinkedIn', shortDesc: 'Import leads and sync B2B contact data from LinkedIn.', logo: '/images/integrations/linkedin.svg', tagColor: '#0a66c2', tagBg: '#0a66c210', envVars: 'LINKEDIN_CLIENT_ID', longDesc: 'Connect LinkedIn to import B2B leads and contacts, sync professional profile data.', features: ['B2B lead import', 'Contact sync', 'Company data', 'InMail integration'], docsUrl: '#' },
